...
public class ScoreTableFragment extends BaseFragment {
    ...
    protected void initializeScreen() {
        ...
        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.scoreTableList);

        ScoreTableAdapter scoreTableAdapter = new ScoreTableAdapter(getActivity(), Dummies.getDummyScoreTable());
